...
- `colour.json`: theme tokens, dashboard tones, course tones, landing accents, ticker colors, and mobile navigation colors.
- `icon.json`: course slug to icon file mapping.
...
2. Update that course entry inside `design/icon.json`
