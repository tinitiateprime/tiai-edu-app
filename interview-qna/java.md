...
- Use an interface when you want capability-based design.
...
- `HashMap` is useful for fast lookup by key.
- Pick the collection based on lookup, ordering, duplicates, and performance needs.
